...
void _cmu418_vset_float(__cmu418_vec_float &vecResult,
                        float value,
                        __cmu418_mask &mask) { _cmu418_vset<float>(vecResult, value, mask); }
void _cmu418_vset_int(__cmu418_vec_int &vecResult, int value, __cmu418_mask &mask) {
  _cmu418_vset<int>(vecResult,
                    value,
                    mask);
}
...
void _cmu418_vadd_float(__cmu418_vec_float &vecResult,
                        __cmu418_vec_float &veca,
                        __cmu418_vec_float &vecb,
                        __cmu418_mask &mask) { _cmu418_vadd<float>(vecResult, veca, vecb, mask); }
void _cmu418_vadd_int(__cmu418_vec_int &vecResult,
                      __cmu418_vec_int &veca,
                      __cmu418_vec_int &vecb,
                      __cmu418_mask &mask) { _cmu418_vadd<int>(vecResult, veca, vecb, mask); }
...
void _cmu418_vsub_float(__cmu418_vec_float &vecResult,
                        __cmu418_vec_float &veca,
                        __cmu418_vec_float &vecb,
                        __cmu418_mask &mask) { _cmu418_vsub<float>(vecResult, veca, vecb, mask); }
void _cmu418_vsub_int(__cmu418_vec_int &vecResult,
                      __cmu418_vec_int &veca,
                      __cmu418_vec_int &vecb,
                      __cmu418_mask &mask) { _cmu418_vsub<int>(vecResult, veca, vecb, mask); }
...
void _cmu418_vmult_float(__cmu418_vec_float &vecResult,
                         __cmu418_vec_float &veca,
                         __cmu418_vec_float &vecb,
                         __cmu418_mask &mask) { _cmu418_vmult<float>(vecResult, veca, vecb, mask); }
void _cmu418_vmult_int(__cmu418_vec_int &vecResult,
                       __cmu418_vec_int &veca,
                       __cmu418_vec_int &vecb,
                       __cmu418_mask &mask) { _cmu418_vmult<int>(vecResult, veca, vecb, mask); }
...
void _cmu418_vdiv_float(__cmu418_vec_float &vecResult,
                        __cmu418_vec_float &veca,
                        __cmu418_vec_float &vecb,
                        __cmu418_mask &mask) { _cmu418_vdiv<float>(vecResult, veca, vecb, mask); }
void _cmu418_vdiv_int(__cmu418_vec_int &vecResult,
                      __cmu418_vec_int &veca,
                      __cmu418_vec_int &vecb,
                      __cmu418_mask &mask) { _cmu418_vdiv<int>(vecResult, veca, vecb, mask); }
...
void _cmu418_vgt_float(__cmu418_mask &maskResult,
                       __cmu418_vec_float &veca,
                       __cmu418_vec_float &vecb,
                       __cmu418_mask &mask) { _cmu418_vgt<float>(maskResult, veca, vecb, mask); }
void _cmu418_vgt_int(__cmu418_mask &maskResult,
                     __cmu418_vec_int &veca,
                     __cmu418_vec_int &vecb,
                     __cmu418_mask &mask) { _cmu418_vgt<int>(maskResult, veca, vecb, mask); }
...
void _cmu418_vlt_float(__cmu418_mask &maskResult,
                       __cmu418_vec_float &veca,
                       __cmu418_vec_float &vecb,
                       __cmu418_mask &mask) { _cmu418_vlt<float>(maskResult, veca, vecb, mask); }
void _cmu418_vlt_int(__cmu418_mask &maskResult,
                     __cmu418_vec_int &veca,
                     __cmu418_vec_int &vecb,
                     __cmu418_mask &mask) { _cmu418_vlt<int>(maskResult, veca, vecb, mask); }
...
void _cmu418_veq_float(__cmu418_mask &maskResult,
                       __cmu418_vec_float &veca,
                       __cmu418_vec_float &vecb,
                       __cmu418_mask &mask) { _cmu418_veq<float>(maskResult, veca, vecb, mask); }
void _cmu418_veq_int(__cmu418_mask &maskResult,
                     __cmu418_vec_int &veca,
                     __cmu418_vec_int &vecb,
...
void _cmu418_interleave_float(__cmu418_vec_float &vecResult, __cmu418_vec_float &vec) {
  _cmu418_interleave<float>(vecResult,
                            vec);
}
